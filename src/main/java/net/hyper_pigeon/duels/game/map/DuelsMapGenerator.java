...
public class DuelsMapGenerator{
    ...
    public @NotNull DuelsMap create() throws GameOpenException {
        ...
        try {
            ...
            throw new GameOpenException(Component.nullToEmpty("Could not load duels map " + config.id + " !"));
        }
        ...
        if (spawn1 == null || spawn2 == null) {
            ...
            throw new GameOpenException(Component.nullToEmpty("Insufficient spawn data!"));
        }
